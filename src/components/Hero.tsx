      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
          <h1 className="text-5xl md:text-7xl font-bold">
            Your Pizza Restaurant's
            <span className="gradient-text block mt-2">AI Phone Assistant</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto">
            Let AI handle your phone orders while you focus on making great pizzas. Perfect for busy restaurants in rural areas.
          </p>
